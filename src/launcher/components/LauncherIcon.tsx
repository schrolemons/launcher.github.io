type LauncherIconProps = {
  className?: string;
  name?: "close" | "fullscreen" | "github" | "image" | "info" | "link" | "monitor" | "muted" | "outbound" | "pause" | "play" | "qq" | "video" | "volume" | "wechat";
};
...
function IconDrawing({ name }: { name: NonNullable<LauncherIconProps["name"]> }) {
  switch (name) {
    ...
    case "image": return <><rect x="3" y="3" width="18" height="18" rx="2" /><circle cx="8.5" cy="8.5" r="1.5" /><path d="M21 15l-5-5-11 11" /></>;
    ...
    case "video": return <><rect x="2" y="6" width="13" height="12" rx="2" /><path d="M15 10.5l7-4v11l-7-4" /></>;
